...
async function testLoginRedirect() {
  try {
    console.log("🧪 Test de connexion et redirection...");
    ...
    if (data.user) {
      ...
      if (sessionData.session) {
        ...
        // 4. Simuler la redirection vers le dashboard
        console.log("🔄 Simulation redirection vers /dashboard...");
        console.log("✅ Redirection réussie - Protection côté client active");
        ...
        setTimeout(async () => {
          ...
          if (persistentSession.session) {
            ...
            console.log("✅ Prêt pour accès au dashboard");
          } else {
