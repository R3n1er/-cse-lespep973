...
export default function Home() {
  return (
    <MainLayout>
      {/* Section principale avec bienvenue à gauche et connexion à droite */}
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 leading-tight">
                  Bienvenue sur votre
                  <span className="text-cse-primary block">
                    espace personnel
                  </span>
                </h2>

                <p className="text-xl text-gray-600 leading-relaxed">
                  Accédez à tous les services et avantages de votre Comité
                  Social et Économique en quelques clics.
                </p>
              </div>
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="text-center">
                    <p className="text-xs text-gray-500">
                      Nouveau ? Contactez votre responsable pour obtenir un
                      accès
                    </p>
                  </div>
                </CardContent>
