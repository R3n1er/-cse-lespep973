...
-- Date: 2025-07-27
-- Description: Résout les problèmes de "infinite recursion detected in policy"

-- 1. Supprimer les politiques RLS problématiques existantes
DO $$ 
BEGIN
    -- Supprimer les politiques existantes de manière sécurisée
...
-- 3. S'assurer que RLS est activé sur toutes les tables
